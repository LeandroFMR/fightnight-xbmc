...
def info_servidores():
    ...
    if selfAddon.getSetting("fontes-rtpplay") == "true":
        try:
                mensagemprogresso.update(12,'',pleasewait + '(RTP Play)')
                if mensagemprogresso.iscanceled(): sys.exit(0)
